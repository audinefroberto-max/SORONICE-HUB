...
getgenv().Message = "Hello,This message is to notify you that you have been banned from our platform. You may no longer use our scripts."
getgenv().Temps = 15

-- LES NOUVELLES OPTIONS DE TEXTE
getgenv().Police = 1          -- 3 = Style Minecraft (1 à 10 disponibles)
...
getgenv().CouleurFond = 2     -- Fond Blanc
